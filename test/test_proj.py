...
class TestRadon3D(unittest.TestCase):
    ...
    def test_proj_x(self):
        ...
        proj = projection(self.testfield, 0, axis=0).cpu().numpy()
        ...
        proj = projection(self.testfield, 90, axis=0).cpu().numpy()
        self.assertTrue(np.allclose(proj, 
            [   [0., 0., 0., 0.],
                [0., 1.01e6, 1.01e2, 0], 
                [0., 1.01e7, 1.01e3, 0.],
    ...
    def test_proj_y(self):
        proj = projection(self.testfield, 0, axis=1).cpu().numpy()
        self.assertTrue(np.allclose(proj, 
            [   [0., 0., 0., 0.],
                [0., 1.0001e4, 1.0001e6, 0.], 
                [0., 1.0001e5, 1.0001e7, 0.],
        ...
        proj = projection(self.testfield, 90, axis=1).cpu().numpy()
        self.assertTrue(np.allclose(proj, 
            [   [0., 0., 0., 0.],
                [0., 1.1e1, 1.1e3, 0.], 
                [0., 1.1e5, 1.1e7, 0.],
    ...
    def test_proj_z(self):
        proj = projection(self.testfield, 0, axis=2).cpu().numpy()
        self.assertTrue(np.allclose(proj, 
            [   [0., 0., 0., 0.],
                [0., 1.0001e4, 1.0001e6, 0.], 
                [0., 1.0001e5, 1.0001e7, 0.],
        ...
        proj = projection(self.testfield, 90, axis=2).cpu().numpy()
        self.assertTrue(np.allclose(proj, 
            [   [0., 0., 0., 0.],
